...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_19.setText(_translate("Dialog", "15住房性质", None))
        self.label_17.setText(_translate("Dialog", "13年龄", None))
        ...
        self.label_13.setText(_translate("Dialog", "9个人状态", None))
        self.label_23.setText(_translate("Dialog", "19电话验证", None))
        ...
        self.label_15.setText(_translate("Dialog", "11居住时间", None))
        self.label_21.setText(_translate("Dialog", "17工作性质", None))
        ...
        self.label_11.setText(_translate("Dialog", "7工作年限", None))
        ...
        self.label_24.setText(_translate("Dialog", "20是否外籍", None))
        ...
        self.label_16.setText(_translate("Dialog", "12个人财产", None))
        ...
        self.label_8.setText(_translate("Dialog", "4贷款目的", None))
        ...
        self.label_20.setText(_translate("Dialog", "16本行信用卡数量", None))
        self.label_22.setText(_translate("Dialog", "18供养人口", None))
        ...
        self.label_5.setText(_translate("Dialog", "1支票账户", None))
        self.label_6.setText(_translate("Dialog", "2支票有效期", None))
        self.spinBox.setToolTip(_translate("Dialog", "用户支票的有效期", None))
        self.label_14.setText(_translate("Dialog", "10其他债务人/担保人", None))
        self.label_10.setText(_translate("Dialog", "6账户存款", None))
        ...
        self.label_7.setText(_translate("Dialog", "3信用历史", None))
        ...
        self.label_9.setText(_translate("Dialog", "5信用卡欠款", None))
        ...
        self.label_18.setText(_translate("Dialog", "14其他分期付款计划", None))
        ...
        self.label_12.setText(_translate("Dialog", "8分期付款占可支配收入的比重", None))
